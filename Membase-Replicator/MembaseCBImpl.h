...
#ifndef Membase_Replicator_MembaseCBImpl_h
#define Membase_Replicator_MembaseCBImpl_h
...
class MembaseCBImpl : public MembaseCallbacks
{
private:
    static std::vector< MP_MC <std::pair <std::string, std::string> >* > *mp_mcMap;
    
public:
    MembaseCBImpl(std::vector< MP_MC <std::pair <std::string, std::string> >* > &map)
    {
        mp_mcMap = &map;
    }
    
    virtual void registerCallbacks(libcouchbase_t mvInstance);
